...
const zhCN = {
  ...
  orchestration: {
    ...
    associatedRunsLede: '展示全部关联 Run，不以数组顺序猜测“当前运行”。',
    openRun: '打开运行',
  },
  runList: {
    eyebrow: '复数运行目录',
  ...
  runOverview: {
    heading: '导调总览',
    lede: '先判断闭环、协作风险和下一步，再进入协作、评测、Trace 或回放核对证据。',
    attention: '下一步关注',
    ...
    teamState: '协作态势',
    teamStateLede:
      '角色状态与真实消息、工件交接分开呈现；Receipt 确认不等同于已读。',
  ...
  collaboration: {
    eyebrow: 'AUTHORITY / RECEIPT FLOW',
    heading: '协作汇流',
    lede: '沿权威 Message、ArtifactVersion 与 Receipt 链观察智能体如何请求、回复和交接；遥测不用于推断知识状态。',
    statusLabel: '协作闭环',
    handoffClosedSuffix: '个专业工件已交接',
    openRequestSuffix: '个请求待响应',
    ...
    handoffs: '工件交接',
    routingMap: '智能体收发矩阵',
    routingProtocol: 'MESSAGE · ARTIFACTVERSION · RECEIPT',
    inbound: '流入',
    outbound: '流出',
    ledger: '协作汇流账本',
    ledgerEyebrow: '因果交换账本',
    ledgerLede: '领域序号决定先后；同一内容的多收件人状态分别核对。',
    exchangeCount: '条权威交换',
    ...
    inspect: '查看交换',
    inspector: '交换详情',
    capturedNotInferred: '已捕获，不推断',
    operator: '导调中枢 / EXCON',
    noArtifact: '此交换没有 ArtifactVersion 引用。',
    noResponse: '此交换没有明确回复。',
    receiptSeq: 'Receipt',
    runSeq: 'Run',
    trustNote:
      '“接收批次已确认”只证明 Receipt 游标已确认，不代表智能体已读、理解或同意。',
...
const en: typeof zhCN = {
  ...
  orchestration: {
    ...
    associatedRunsLede:
      'Every related Run is listed; array order never defines the current Run.',
    openRun: 'Open run',
  },
  runList: {
  ...
  runOverview: {
    ...
    lede: 'Judge closure, collaboration risk, and the next drill-down before opening collaboration, evaluation, Trace, or replay evidence.',
    ...
    teamStateLede:
      'Role state and real message or artifact handoffs stay distinct; Receipt acknowledgement never means read.',
  ...
  collaboration: {
    ...
    lede: 'Follow authoritative Message, ArtifactVersion, and Receipt chains to see how agents request, respond, and hand off. Telemetry never infers knowledge state.',
    statusLabel: 'Collaboration closure',
    handoffClosedSuffix: 'specialist artifacts handed off',
    openRequestSuffix: 'requests awaiting response',
    ...
    inbound: 'Inbound',
    outbound: 'Outbound',
    ledger: 'Collaboration confluence ledger',
    ledgerEyebrow: 'Causal exchange ledger',
    ledgerLede:
    ...
    complete: 'Delivery closed',
    inspect: 'Inspect exchange',
    inspector: 'Exchange detail',
    capturedNotInferred: 'Captured, not inferred',
    ...
    runSeq: 'Run',
    trustNote:
      '“Receipt batch acknowledged” proves only that the Receipt cursor was acknowledged; it does not mean the agent read, understood, or agreed.',
