...
| Skill/MCP           | v2-first RunAgent Skill; 17 stdio MCP Tools including Receipt-gated safe Submission recovery; explicit v1 compatibility                              | Complete evaluator → rework → resubmit is not connected                                              |
