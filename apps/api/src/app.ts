...
const publicErrorStatus: Readonly<Record<ApiErrorCode, number>> = {
  ...
  TASK_LEASE_NOT_EXTENDED: 409,
  TASK_LEASE_MAX_EXCEEDED: 409,
  INVALID_TASK_LEASE_WINDOW: 422,
  RESOURCE_NOT_ISSUED: 403,
  MESSAGE_NOT_FOUND: 404,
  MESSAGE_REPLY_CONFLICT: 409,
  MESSAGE_RECIPIENT_CONFLICT: 409,
  RECEIPT_REFERENCE_CONFLICT: 422,
  ARTIFACT_NOT_FOUND: 404,
  ARTIFACT_KEY_CONFLICT: 409,
  ARTIFACT_BASE_CONFLICT: 409,
  SUBMISSION_NOT_FOUND: 404,
  SUBMISSION_CONFLICT: 409,
  FEEDBACK_GRANT_NOT_FOUND: 404,
  FEEDBACK_GRANT_VERSION_CONFLICT: 409,
  FEEDBACK_GRANT_REVOKED: 409,
  FEEDBACK_GRANT_SCOPE_MISMATCH: 403,
  FEEDBACK_GRANT_EXPIRED: 409,
  FEEDBACK_GRANT_EXHAUSTED: 409,
