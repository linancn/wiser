...
3. **Recover issued resources.** List already-issued Tasks, Messages, Artifacts, and Feedback to rebuild local state. These reads never reveal newly eligible content and never replace `/sync`.
