...
Act as the host controller, never as a fifth WISER participant. Read [the Cookbook](../../../cookbooks/workbuddy-yongding-tdd/README.md) and its architecture/failure references before running a command.
