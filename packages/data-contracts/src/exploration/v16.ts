/** Immutable exploration 1.6 definitions. */
import { z } from 'zod';
import {
...
export const ExplorationQueryInputV16Schema = z
  .strictObject({
...
export const ExplorationResultV16Schema = z
  .strictObject({
...
export type ExplorationQueryInputV16 = z.infer<
  typeof ExplorationQueryInputV16Schema
>;
export type ExplorationResultV16 = z.infer<typeof ExplorationResultV16Schema>;
