/** Immutable exploration 1.9 definitions. */
import { z } from 'zod';
import {
...
export * from './v18.ts';
export const ExplorationQueryInputV19Schema = z
  .strictObject({
...
export const ExplorationResultV19Schema = ExplorationResultV18Schema;
export type ExplorationQueryInputV19 = z.infer<
  typeof ExplorationQueryInputV19Schema
>;
export type ExplorationResultV19 = z.infer<typeof ExplorationResultV19Schema>;
