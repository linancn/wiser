/** Immutable exploration 1.3 definitions. */
import { z } from 'zod';
import {
  QuerySpecV1Schema,
...
export const ExplorationQueryInputV13Schema = z
  .strictObject({
...
export const ExplorationResultV13Schema = z
  .strictObject({
...
export type ExplorationQueryInputV13 = z.infer<
  typeof ExplorationQueryInputV13Schema
>;
export type ExplorationResultV13 = z.infer<typeof ExplorationResultV13Schema>;
