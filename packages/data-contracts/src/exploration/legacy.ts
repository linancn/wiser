/** Immutable exploration 1.0–1.2 definitions. Extend new contracts separately. */
import { z } from 'zod';
...
export const QuerySpecV1Schema = z.strictObject({
...
export const ExplorationQueryInputV1Schema = z
  .strictObject({
    spec: QuerySpecV1Schema.optional(),
...
export const ExplorationQueryInputV12Schema = z
  .strictObject({
    ...ExplorationQueryInputV1Schema.shape,
...
export const ExplorationReadinessV1Schema = z.enum([
  'NOT_PARSED',
  'READY',
  'PARTIAL',
  'UNSUPPORTED',
...
export const ExplorationResourceV1Schema = z.strictObject({
  ...
  readiness: z.strictObject({
    records: ExplorationReadinessV1Schema,
    spatial: ExplorationReadinessV1Schema,
    graph: ExplorationReadinessV1Schema,
  }),
...
export const ExplorationResourceV12Schema = ExplorationResourceV1Schema.extend({
  analysis: z
    .strictObject({
...
export const ExplorationResultV11Schema = z
  .strictObject({
    ...
    view: z.enum(['resources', 'records', 'map']),
    resources: z.array(ExplorationResourceV12Schema).max(200),
...
export const ExplorationResultV12Schema = z
  .strictObject({
    ...ExplorationResultV1Schema.shape,
    view: z.enum(['resources', 'records', 'map', 'graph']),
    resources: z.array(ExplorationResourceV12Schema).max(200),
...
export type ExplorationQueryInputV12 = z.infer<
  typeof ExplorationQueryInputV12Schema
>;
export type ExplorationResultV12 = z.infer<typeof ExplorationResultV12Schema>;
export type ExplorationResourceV12 = z.infer<
  typeof ExplorationResourceV12Schema
>;
