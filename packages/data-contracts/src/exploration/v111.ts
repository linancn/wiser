/** Frozen exploration 1.11 shapes used by saved-view protocol 1.0. */
import { z } from 'zod';
import {
...
export const ExplorationQueryInputV111Schema = z
  .strictObject({
...
export const ExplorationResultV111Schema = z
  .strictObject({
...
export type ExplorationQueryInputV111 = z.infer<
  typeof ExplorationQueryInputV111Schema
>;
export type ExplorationResultV111 = z.infer<typeof ExplorationResultV111Schema>;
